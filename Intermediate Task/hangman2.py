...
def getRandomWord(wordList):                                                 
    # This function returns a random string from wordList                    
...
while True:                                                                  
    ...
    if guess in secretWord:                                                  
        ...
        if len(missedLetters) == len(HANGMAN_PICS) - 1:                      
            displayBoard(HANGMAN_PICS, missedLetters, correctLetters, secretWord)
            print('You have run out of guesses!\nAfter ' + str(len(missedLetters)) + ' incorrect guesses and ' + str(len(correctLetters)) + ' correct guesses, the word was "' + secretWord + '"')
            gameIsDone = True                                                
